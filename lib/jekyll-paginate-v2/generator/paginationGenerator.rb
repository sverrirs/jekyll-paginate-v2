  ...
  module PaginateV2::Generator
    ...
    class PaginationGenerator < Generator
      ...
      # begin
        ...
        unless site.config['paginate'].nil?
          ...
          unless site.config['pagination'].nil?
          ...
          unless site.config['paginate_path'].nil?
        ...
        unless default_config['title_suffix'].nil?
        ...
        collection_by_name_lambda = lambda do |collection_name|
          ...
          if collection_name == "all"
            ...
            return [] unless site.collections.has_key?(collection_name)
